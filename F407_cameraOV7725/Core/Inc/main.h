...
/* Private defines -----------------------------------------------------------*/
#define FIFO_WRST_Pin GPIO_PIN_0
#define FIFO_WRST_GPIO_Port GPIOC
#define FIFO_RRST_Pin GPIO_PIN_1
#define FIFO_RRST_GPIO_Port GPIOC
#define FIFO_OE_Pin GPIO_PIN_2
#define FIFO_OE_GPIO_Port GPIOC
#define FIFO_RCLK_Pin GPIO_PIN_3
#define FIFO_RCLK_GPIO_Port GPIOC
