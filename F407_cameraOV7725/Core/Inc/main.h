...
#define FIFO_WRST_Pin GPIO_PIN_10
#define FIFO_WRST_GPIO_Port GPIOD
#define FIFO_RRST_Pin GPIO_PIN_11
#define FIFO_RRST_GPIO_Port GPIOD
#define FIFO_OE_Pin GPIO_PIN_12
#define FIFO_OE_GPIO_Port GPIOD
#define FIFO_RCLK_Pin GPIO_PIN_13
#define FIFO_RCLK_GPIO_Port GPIOD
#define FIFO_WEN_Pin GPIO_PIN_14
